...
#python Sticher.py target.jpg 20 rgb mymosaic.jpg
...
def run_stitcher(target, tile_size, rgb_or_hsv, output):
    ...
    inputImagePath =  target #str(sys.argv[1])
    tileSize = tile_size # int(sys.argv[2])
    channels = rgb_or_hsv # list(str(sys.argv[3]))
    ...
    cv2.imwrite(str(output), inputImage)
